module Template.Layer.Passthrough
  ( Passthrough(..)
  , mkPassthrough
  ) where
...
import Template.Layer (class Layer, class LayerWrapper, class Scalable, drag, dragEnd, dragStart, draw, mapLayerWrapper, position, scale, translate)
