...
import Template.Layer (class Layer, class LayerWrapper, DragOffset, containsPoint, drag, dragEnd, dragStart, dragTranslate, draw, mapLayerWrapper, position, translate)
